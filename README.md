...
attention to the inverted y pixel positions of the screenbuffer. And texture coordinate (0,1) accesses lower part of texture. OpenGL states (0,1) should be upper part of the image.
