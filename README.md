...
_YELLOW.CPP is "Yellow Rose of Texas" a 4k by Fit and Bandwagon.  
...
(Better use the public domain PModeW instead of Dos4GW for 256 MB of memory instead of 32 MB on WatcomC++)  
## Typical usage
#include "gl.h"  
